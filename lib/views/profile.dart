...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        child: Scaffold(
          appBar: App().appBarBack(context, 'Profile', onPressed: () {
      ...
      child: ListView(
        children: [
            ...
            child: Row(
              children: [
                BorderContainer(
                  ...
                  child: Content(
                    margin: EdgeInsets.all(20),
                    text: ProfileViewModel.name.length > 2
                        ? ProfileViewModel.name.substring(0, 2).toUpperCase()
                        : "IN",
                    textHeight: 1.5,
          ...
          Line(
            width: 100,
            height: 3,
            color: AppColors.SECONDARY_COLOR_LIGHT,
