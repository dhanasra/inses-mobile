...
class EdCategory extends StatefulWidget {
  @override
  _EdCategoryState createState() => _EdCategoryState();
}

class _EdCategoryState extends State<EdCategory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: App().appBarBack(context, 'Edit category',
            child: SizedBox(
              width: 45,
              height: 45,
              child: IconButton(
                ...
                onPressed: () {
                  print(2);
                  editBloc.add(
                      DeleteCategory(categoryId: EditViewModel.category!.id!));
                },
              ),
            )),
        body: Form(
              ...
              picked1
                  ...
                  : BorderContainer(
                      ...
                      child: ImageView(
                        ...
                        width: 80,
                        url: EditViewModel.category?.image,
                      ),
                    ),
              OnTapField(
                  child: Container(
