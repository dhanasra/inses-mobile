...
class _UpdateBookingStatusState extends State<UpdateBookingStatus> {
  ...
  Widget buildView(
      bool isLoading, bool isLoading3, bool isLoading1, bool isLoading2) {
    return isLoading
        ? Row(
              ...
              Stack(
                children: [
                  ImageContainer(
                    ...
                    radius: 0,
                    url:
                        'https://images.unsplash.com/photo-1596394723269-b2cbca4e6313?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fHBsdW1iaW5nfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
                    child: Column(
                      children: [
                        Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Content(
                                      ...
                                      color:
                                          AppColors.SUCCESS_COLOR_EXTRA_LIGHT,
                        ...
                        Content(
                          ...
                          textHeight: 1.5,
                          text:
                              'Get lowest prices for ${OrderViewModel.booking!.categoryName} in Madurai',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Content(
                              color: AppColors.BLACK,
                              text:
                                  '\u20B9 ${OrderViewModel.booking!.totalPrice}',
                              margin: EdgeInsets.only(top: 5),
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Content(
                                        ...
                                        margin: EdgeInsets.only(top: 5),
                                        text:
                                            '\u20B9 ${OrderViewModel.booking!.additionalPrice}',
                                        overflow: TextOverflow.ellipsis,
                                        fontfamily: AppFont.FONT,
                                        fontWeight: FontWeight.w500,
                                        fontSize: AppDimen.TEXT_SMALLER,
                                ...
                                child: BorderContainer(
                                    ...
                                    child: OnTapField(
                                      ...
                                      onTap: () {
                                        ...
                                        bloc.add(ApproveOrder(
                                            categoryId:
                                                OrderViewModel.booking!.id));
                                      },
                                    ))),
                            Visibility(
                                visible:
                                    type != 'COMPLETED' && additional == 'ADD',
                                child: BorderContainer(
                                    radius: 4,
                                    margin: EdgeInsets.only(
                                        left: 15, right: 15, top: 30),
                                    ...
                                    child: OnTapField(
                                      ...
                                      onTap: () {
                                        App().setNavigation(context,
                                            AppRoutes.APP_ADDITIONAL_CHARGE);
                                      },
                                    ))),
                            Visibility(
                                visible: type != 'COMPLETED' &&
                                    additional == 'ADDED',
                                child: BorderContainer(
                                    radius: 4,
                                    margin: EdgeInsets.only(
                                    ...
                                    child: OnTapField(
                                      ...
                                      onTap: () {
                                        ...
                                        bloc.add(RemoveAdditionalCharge(
                                            id: OrderViewModel
                                                .booking!.additionalId!));
                                      },
                                    ))),
                            Visibility(
